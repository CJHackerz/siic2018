         ...
         <div class="w3-third">
            <div class="w3-white w3-text-grey w3-card-4" style="border-radius:5px;">
               ...
               <div class="w3-container">
                  ...
                  <div class="main-heading-content text-center" style="padding-bottom:-40px;">
                     <h2><?php echo $team_name;?><span>.</span></h2>
                  </div>
               </div>
            </div>
            <br>
  ...
  <div class="w3-row-padding" >
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4" style="border-radius:5px;">
        <div class="w3-display-container" >
          <ul class="list-group list-group-flush">
   <li class="list-group-item"><div style="padding: 0px 0px 0px 0px;" align="center" class='team_image_hover'><img class="img-thumbnail" src="./teams/img/<?php echo $logo; ?>" alt="Team Logo"; height="100px" width="100%">
