...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2018 at 11:01 AM
...
CREATE TABLE `freelance` (
  ...
  `contentwriting` varchar(100) NOT NULL,
  `graphicdesign` varchar(100) NOT NULL,
  `corporate` varchar(100) NOT NULL,
  `sandm` varchar(100) NOT NULL,
  `mechanical` varchar(100) NOT NULL,
  `threeD` varchar(100) NOT NULL,
  `mandf` varchar(100) NOT NULL,
  `automation` varchar(100) NOT NULL,
  `hardware` varchar(100) NOT NULL,
  `EDA` varchar(100) NOT NULL,
  `generalengg` varchar(100) NOT NULL,
  `websites` varchar(100) NOT NULL,
  `proglang` varchar(100) NOT NULL,
  `mobappdev` varchar(100) NOT NULL,
