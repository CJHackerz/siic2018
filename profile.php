...
<body id="page-top">
       ...
       <!--  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#skills">Startups</a>
                </li>
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                   <a class="nav-link js-scroll-trigger" href="./process/process_logout.php">Logout</a>
                 </li>
    ...
    <!--====================================================
                           STARTUPS
    ======================================================-->
    <section class="resume-section p-3 p-lg-5 " id="startups">
        <div class="row my-auto">
            <div class="col-12">
              ...
              <div class="card mx-0 p-4 mb-5" style="border-color: #2196f3; box-shadow: 2px 2px 2px rgba(0, 0, 0, 0.21);">
                ...
                <div class="resume-date text-md-right">
                    <span class="text-primary">September 2018 - June 2019</span>
                                ...
                                <!-- TEAMS -->
    <section class="resume-section p-3 p-lg-5 " id="teams">
        <div class="row my-auto">
            <div class="col-12">
